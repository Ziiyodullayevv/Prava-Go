...
const bottomSheetIndicatorStyle = tva({
	base: "py-3 w-full items-center",
});

const bottomSheetItemStyle = tva({
	base: "p-3 flex-row items-center rounded-[400px] w-full disabled:opacity-0.4 web:pointer-events-auto disabled:cursor-not-allowed hover:bg-background-50 active:bg-background-100 focus:bg-background-100 web:focus-visible:bg-background-100",
});
